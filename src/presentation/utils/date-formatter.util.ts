...
export class DateFormatterUtil {
	private static formatterOptions: Record<DateFormatTemplate, Intl.DateTimeFormatOptions> = {
		'd MMMM yyyy': {
			day: 'numeric',
			month: 'long',
			year: 'numeric',
	...
	static format(template: DateFormatTemplate, date: Date, locale: string = 'ru-RU'): string {
