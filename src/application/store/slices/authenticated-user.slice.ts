...
export const authenticatedUserSlice = createSlice({
	...
	reducers: {
		setAuthenticatedUser: (_: AuthenticatedUserStateType, action: PayloadAction<AuthenticatedUserEntity>): AuthenticatedUserStateType => {
			return {
				authenticatedUser: action.payload
			}
		},

		clearAuthenticatedUser: (_1: AuthenticatedUserStateType, _2: PayloadAction<null>): AuthenticatedUserStateType => {
			return {
				authenticatedUser: null
			};
		}
